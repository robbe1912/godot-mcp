  ...
  private setupToolHandlers() {
    ...
    this.server.setRequestHandler(ListToolsRequestSchema, async () => ({
      tools: [
        ...
        {
          name: 'game_eval',
          description: 'Execute a single GDScript expression in the running game. Supports property access, method calls, math, and global singletons (Engine, Input, Time, OS, etc.). Does NOT support multi-line code, var/func declarations, or control flow — use game_call_method or game_set_property for those. Uses the SceneTree root as base context, so get_node("/root/...") works naturally. Examples: get_node("/root/Player/HealthComponent").health, Engine.get_frames_per_second(), Input.is_action_pressed("jump")',
          inputSchema: {
            type: 'object',
            properties: {
              code: {
                type: 'string',
                description: 'A single GDScript expression to evaluate. Supports property access, method calls, math. No return keyword needed — the expression value is returned automatically. No multi-line code.',
              },
            },
            required: ['code'],
          },
        ...
        },
        {
          ...
          inputSchema: {
            ...
            properties: {
              ...
              args: { type: 'array', items: { type: 'object' }, description: 'Optional arguments to pass with the signal' },
            },
        ...
        },
{
        ...
        },
        {
          ...
          inputSchema: {
            ...
            properties: {
              ...
              cells: { type: 'array', items: { type: 'object' }, description: 'Array of cell objects for set_cells/erase_cells' },
        ...
        },
        {
          ...
          inputSchema: {
            ...
            properties: {
              ...
              tracks: { type: 'array', items: { type: 'object' }, description: 'Array of track definitions' },
        ...
        },
        {
          ...
          inputSchema: {
            ...
            properties: {
              ...
              args: { type: 'array', items: { type: 'object' }, description: 'Arguments for the RPC call' },
        ...
        },
        {
          ...
          inputSchema: {
            ...
            properties: {
              parentPath: { type: 'string', description: 'Parent node path' },
              vertices: { type: 'array', items: { type: 'object' }, description: 'Vertex positions [[x,y,z],...]' },
              normals: { type: 'array', items: { type: 'object' }, description: 'Vertex normals [[x,y,z],...]' },
              uvs: { type: 'array', items: { type: 'object' }, description: 'UV coordinates [[u,v],...]' },
              indices: { type: 'array', items: { type: 'number' }, description: 'Triangle indices [i0,i1,i2,...]' },
              name: { type: 'string', description: 'Node name' },
            },
        ...
        },
        {
          ...
          inputSchema: {
            ...
            properties: {
              ...
              points: { type: 'array', items: { type: 'object' }, description: 'Polygon points [{x,y},...]' },
        ...
        },
        {
          ...
          inputSchema: {
            ...
            properties: {
              ...
              points: { type: 'array', items: { type: 'object' }, description: 'Array of points [{x,y},...]' },
        ...
        },
        {
          ...
          inputSchema: {
            ...
            properties: {
              ...
              methods: { type: 'array', items: { type: 'object' }, description: 'Method stubs to include' },
        ...
        },
        {
          ...
          inputSchema: {
            ...
            properties: {
              ...
              heightData: { type: 'array', items: { type: 'number' }, description: 'Array of float height values (for create)' },
        ...
        },
        {
          ...
          inputSchema: {
            ...
            properties: {
              ...
              action: { type: 'string', description: 'Action: create or read' },
              platforms: { type: 'array', items: { type: 'string' }, description: 'Target platforms: windows, linux, macos, web' },
